...
const int pinCS = 10;
const int numberOfHorizontalDisplays = 8; //Numero de displays
...
void loop(){
  //Variable cadena: introducir el texto a mostrar en el letrero
   String cadena = "GUARDIANES: EN ESTA ZONA NO SE PERMITE EL USO DEL CELULAR  * PROHIBIDO TOMAR FOTOS A TESIS Y LIBROS  * RECUERDA TRAER TU CREDENCIAL PARA EL PRESTAMO DE LIBROS. ";
